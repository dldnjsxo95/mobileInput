...
namespace TMPro.EditorUtilities
{
    ...
    [CustomEditor(typeof(MobileInputField), true)]
    public class MobileInputFieldEditor : SelectableEditor
    {
        ...
        public override void OnInspectorGUI()
        {
            ...
            if (m_foldout.fontSettings)
            {
                ...
                {
                    MobileInputField inputField = target as MobileInputField;
                ...
                if (!m_ContentType.hasMultipleDifferentValues)
                {
                    ...
                    if (m_ContentType.enumValueIndex == (int)MobileInputField.ContentType.Standard ||
                        m_ContentType.enumValueIndex == (int)MobileInputField.ContentType.Autocorrected ||
                        m_ContentType.enumValueIndex == (int)MobileInputField.ContentType.Custom)
                    {
                        EditorGUI.BeginChangeCheck();
                        ...
                        if (EditorGUI.EndChangeCheck())
                        {
                            if (text != null)
                            {
                                if (m_LineType.enumValueIndex == (int)MobileInputField.LineType.SingleLine)
                    ...
                    if (m_ContentType.enumValueIndex == (int)MobileInputField.ContentType.Custom)
                    {
                        ...
                        if (m_CharacterValidation.enumValueIndex == (int)MobileInputField.CharacterValidation.Regex)
                        {
                            EditorGUILayout.PropertyField(m_RegexValue);
                        }
                        else if (m_CharacterValidation.enumValueIndex == (int)MobileInputField.CharacterValidation.CustomValidator)
                        {
